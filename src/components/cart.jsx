...
return <div className="py-16 bg-white/10 flex  flex-col   font-playfair min-h-screen text-center ">
    ...
    
{
  cart.map((e,index)=>(
    ...
    <div className="border-t pt-2 flex justify-between text-xl font-bold">
      <span>Total:</span>
      <span className="text-[#BA7894] font-manrope ">₹{total.toFixed(2)}</span>
    </div>
  </div>
