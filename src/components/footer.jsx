...
export default function Footer(){
    ...
    return <div className=" font-playfair  items-end bg-[#241520]">
...
<div className=" flex flex-row items-center md:space-x-8 space-x-4 md:justify-around p-1  py-4 border-b border-gray-300  border-opacity-30 ">
    ...
    <div className=" flex flex-row space-x-2  items-center"><img src="/images/logo.png" alt="" />
    <h1 className="  md:text-2xl text-sm font-bold font-pacifico  text-[#BA7894] ">MIRACLE GLOW </h1>
    </div>
...
<p className="text-sm mt-2 mb-[0%] h-10 text-center flex items-center justify-center text-white text-opacity-70 bg-[#160813]">
      &copy; 2025 MIRACLE GLOW. All rights reserved.
    </p>
